...
export const getQuizData = (lang: Language): QuizCategory[] => {
  ...
  return [
    ...
    },
    {
      id: 'inventory',
      title: isHi ? 'इन्वेंट्री (Inventory)' : 'Inventory Management',
      description: isHi ? 'स्टॉक और गोदाम प्रबंधन' : 'Stock levels, warehouse, and tracking',
      icon: 'Package',
      duration: 30,
      questions: [
        {
        ...
        },
        {
          id: 'inv2',
          question: isHi ? 'FIFO का पूर्ण रूप क्या है?' : 'What is the full form of FIFO?',
          options: isHi ? ['First In, First Out', 'Fast In, Fast Out', 'First In, Final Out', 'Final In, First Out'] : ['First In, First Out', 'Fast In, Fast Out', 'First In, Final Out', 'Final In, First Out'],
          correctAnswer: 0,
          level: 'beginner'
        },
        {
        ...
        },
        {
          id: 'inv11',
          question: isHi ? 'VMI का पूर्ण रूप क्या है?' : 'What is the full form of VMI?',
          options: isHi ? ['Vendor Managed Inventory', 'Value Managed Item', 'Variable Material Index', 'Volume Management Interface'] : ['Vendor Managed Inventory', 'Value Managed Item', 'Variable Material Index', 'Volume Management Interface'],
          correctAnswer: 0,
          level: 'intermediate'
        },
        {
          id: 'inv12',
          question: isHi ? 'इन्वेंट्री में "Shrinkage" का क्या अर्थ है?' : 'What does "Shrinkage" mean in inventory?',
          options: isHi ? ['चोरी या क्षति के कारण स्टॉक में कमी', 'स्टॉक का आकार छोटा होना', 'कीमत कम होना', 'सफाई'] : ['Loss of stock due to theft or damage', 'Stock getting smaller', 'Price reduction', 'Cleaning'],
          correctAnswer: 0,
          level: 'intermediate'
        },
        {
          id: 'inv13',
          question: isHi ? 'JIT इन्वेंट्री का मुख्य लाभ क्या है?' : 'What is the main benefit of JIT inventory?',
          options: isHi ? ['भंडारण लागत में कमी', 'अधिक स्टॉक', 'धीमी डिलीवरी', 'उच्च लागत'] : ['Reduced storage cost', 'More stock', 'Slower delivery', 'Higher cost'],
          correctAnswer: 0,
          level: 'beginner'
        },
        {
          id: 'inv14',
          question: isHi ? 'इन्वेंट्री में "Lead Time" क्या है?' : 'What is "Lead Time" in inventory?',
          options: isHi ? ['ऑर्डर देने से प्राप्त करने तक का समय', 'सामान बेचने का समय', 'मशीन चलाने का समय', 'सफाई का समय'] : ['Time from ordering to receiving', 'Time to sell goods', 'Time to run machine', 'Time for cleaning'],
          correctAnswer: 0,
          level: 'beginner'
        },
        {
          id: 'inv15',
          question: isHi ? 'ABC विश्लेषण में "C" श्रेणी क्या है?' : 'What is category "C" in ABC analysis?',
          options: isHi ? ['कम मूल्य, उच्च मात्रा', 'उच्च मूल्य, कम मात्रा', 'मध्यम मूल्य', 'महंगा सामान'] : ['Low value, high quantity', 'High value, low quantity', 'Medium value', 'Expensive goods'],
          correctAnswer: 0,
          level: 'intermediate'
        },
        {
          id: 'inv16',
          question: isHi ? 'इन्वेंट्री में "Carrying Cost" में क्या शामिल है?' : 'What is included in "Carrying Cost" in inventory?',
          options: isHi ? ['भंडारण, बीमा और अवसर लागत', 'केवल खरीद मूल्य', 'केवल शिपिंग', 'केवल कर'] : ['Storage, insurance, and opportunity cost', 'Only purchase price', 'Only shipping', 'Only taxes'],
          correctAnswer: 0,
          level: 'advanced'
        },
        {
          id: 'inv17',
          question: isHi ? 'रीऑर्डर पॉइंट (ROP) क्या है?' : 'What is Reorder Point (ROP)?',
          options: isHi ? ['वह स्तर जिस पर नया ऑर्डर देना चाहिए', 'स्टॉक खत्म होने का समय', 'सामान बेचने का समय', 'सफाई का समय'] : ['Level at which a new order should be placed', 'Time when stock ends', 'Time to sell goods', 'Time for cleaning'],
          correctAnswer: 0,
          level: 'intermediate'
        },
        {
          id: 'inv18',
          question: isHi ? 'इन्वेंट्री में "MRO" का क्या अर्थ है?' : 'What does "MRO" stand for in inventory?',
          options: isHi ? ['Maintenance, Repair, and Operations', 'Material Resource Order', 'Machine Run Output', 'Management Report Office'] : ['Maintenance, Repair, and Operations', 'Material Resource Order', 'Machine Run Output', 'Management Report Office'],
          correctAnswer: 0,
          level: 'intermediate'
        },
        {
          id: 'inv19',
          question: isHi ? 'वर्चुअल इन्वेंट्री (Virtual Inventory) क्या है?' : 'What is Virtual Inventory?',
          options: isHi ? ['सिस्टम में दिखने वाला स्टॉक', 'असली स्टॉक', 'पुराना स्टॉक', 'टूटा हुआ स्टॉक'] : ['Stock visible in the system', 'Real stock', 'Old stock', 'Broken stock'],
          correctAnswer: 0,
          level: 'intermediate'
        },
        {
          id: 'inv20',
          question: isHi ? 'इन्वेंट्री में "Backorder" क्या है?' : 'What is a "Backorder" in inventory?',
          options: isHi ? ['स्टॉक न होने पर लिया गया ऑर्डर', 'वापस किया गया सामान', 'पुराना ऑर्डर', 'गलत ऑर्डर'] : ['Order taken when stock is unavailable', 'Returned goods', 'Old order', 'Wrong order'],
          correctAnswer: 0,
          level: 'beginner'
        },
        {
          id: 'inv21',
          question: isHi ? 'इन्वेंट्री में "Safety Stock" की गणना कैसे की जाती है?' : 'How is "Safety Stock" calculated in inventory?',
          options: isHi ? ['मांग और लीड टाइम की अनिश्चितता के आधार पर', 'केवल वजन के आधार पर', 'केवल कीमत के आधार पर', 'बिना किसी आधार के'] : ['Based on uncertainty in demand and lead time', 'Based only on weight', 'Based only on price', 'Without any basis'],
          correctAnswer: 0,
          level: 'advanced'
        },
        {
          id: 'inv22',
          question: isHi ? 'इन्वेंट्री में "WIP" का क्या महत्व है?' : 'What is the importance of "WIP" in inventory?',
          options: isHi ? ['यह उत्पादन की प्रगति को दर्शाता है', 'यह केवल कचरा है', 'यह महत्वपूर्ण नहीं है', 'यह केवल लागत है'] : ['It shows production progress', 'It is only waste', 'It is not important', 'It is only cost'],
          correctAnswer: 0,
          level: 'intermediate'
        },
        {
          id: 'inv23',
          question: isHi ? 'इन्वेंट्री में "Consignment Stock" क्या है?' : 'What is "Consignment Stock" in inventory?',
          options: isHi ? ['आपूर्तिकर्ता का स्टॉक जो ग्राहक के पास है', 'ग्राहक का स्टॉक', 'पुराना स्टॉक', 'टूटा हुआ स्टॉक'] : ['Supplier stock held by customer', 'Customer stock', 'Old stock', 'Broken stock'],
          correctAnswer: 0,
          level: 'advanced'
        },
        {
          id: 'inv24',
          question: isHi ? 'इन्वेंट्री में "Obsolete Inventory" क्या है?' : 'What is "Obsolete Inventory" in inventory?',
          options: isHi ? ['वह स्टॉक जिसकी अब आवश्यकता नहीं है', 'नया स्टॉक', 'महंगा स्टॉक', 'सस्ता स्टॉक'] : ['Stock that is no longer needed', 'New stock', 'Expensive stock', 'Cheap stock'],
          correctAnswer: 0,
          level: 'intermediate'
        },
        {
          id: 'inv25',
          question: isHi ? 'इन्वेंट्री में "Buffer Stock" का क्या कार्य है?' : 'What is the function of "Buffer Stock" in inventory?',
          options: isHi ? ['आकस्मिक मांग को पूरा करना', 'स्टोर भरना', 'पैसे बचाना', 'सजावट'] : ['Meeting unexpected demand', 'Filling store', 'Saving money', 'Decoration'],
          correctAnswer: 0,
          level: 'intermediate'
        },
        {
          id: 'inv26',
          question: isHi ? 'इन्वेंट्री में "Lot Size" क्या है?' : 'What is "Lot Size" in inventory?',
          options: isHi ? ['एक बार में ऑर्डर की गई मात्रा', 'स्टोर का आकार', 'मशीन का आकार', 'कर्मचारी की संख्या'] : ['Quantity ordered at one time', 'Store size', 'Machine size', 'Number of workers'],
          correctAnswer: 0,
          level: 'beginner'
        },
        {
          id: 'inv27',
          question: isHi ? 'इन्वेंट्री में "Cross-docking" का मुख्य उद्देश्य क्या है?' : 'What is the main goal of "Cross-docking" in inventory?',
          options: isHi ? ['भंडारण को कम करना और गति बढ़ाना', 'अधिक भंडारण', 'धीमी डिलीवरी', 'उच्च लागत'] : ['Reducing storage and increasing speed', 'More storage', 'Slower delivery', 'Higher cost'],
          correctAnswer: 0,
          level: 'advanced'
        },
        {
          id: 'inv28',
          question: isHi ? 'इन्वेंट्री में "Stock Keeping Unit" (SKU) क्या isHi ?' : 'What is a "Stock Keeping Unit" (SKU) in inventory?',
          options: isHi ? ['प्रत्येक उत्पाद के लिए एक विशिष्ट कोड', 'मशीन का नाम', 'कर्मचारी का नाम', 'स्टोर का नाम'] : ['A unique code for each product', 'Machine name', 'Employee name', 'Store name'],
          correctAnswer: 0,
          level: 'beginner'
        },
        {
          id: 'inv29',
          question: isHi ? 'इन्वेंट्री में "Economic Order Quantity" (EOQ) का सूत्र क्या है?' : 'What is the formula for "Economic Order Quantity" (EOQ) in inventory?',
          options: isHi ? ['√(2DS/H)', 'D+S+H', 'D*S*H', 'D/S/H'] : ['√(2DS/H)', 'D+S+H', 'D*S*H', 'D/S/H'],
          correctAnswer: 0,
          level: 'advanced'
        },
        {
          id: 'inv30',
          question: isHi ? 'इन्वेंट्री में "Inventory Accuracy" क्यों महत्वपूर्ण है?' : 'Why is "Inventory Accuracy" important in inventory?',
          options: isHi ? ['बेहतर योजना और कम लागत के लिए', 'सजावट के लिए', 'पैसे खर्च करने के लिए', 'सफाई के लिए'] : ['For better planning and lower cost', 'For decoration', 'To spend money', 'For cleaning'],
          correctAnswer: 0,
          level: 'intermediate'
        }
      ]
